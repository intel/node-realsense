...
describe('Test Device interfaces', function() {
  ...
  it('Negative - Call enableStream with no option', function() {
    return new Promise((resolve, reject) => {
      device.enableStream().then((enable) => {
  ...
  it('Negative - Call enableStream with 1 option', function() {
    return new Promise((resolve, reject) => {
      device.enableStream('depth').then((enable) => {
        reject('Should get reject but got resolved promise');
      }).catch((e) => {
        resolve();
      });
  ...
  it('Negative - Call getStreamModeCount with illegal options', function() {
    return new Promise((resolve, reject) => {
      device.enableStream('dummy', mode).then((enable) => {
        reject('Should get reject but got resolved promise');
      }).catch((e) => {
        resolve();
      });
...
function testOptions(option) {
  describe('Test Device interfaces', function() {
    ...
    it('Positive - Call enableStream with ' + option, function() {
      return new Promise((resolve, reject) => {
