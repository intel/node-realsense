...
#ifndef _SKELETON_POINT_INFO_H_
#define _SKELETON_POINT_INFO_H_
...
class SkeletonPointInfo {
 public:
  ...
  SkeletonPointInfo(const SkeletonPointInfo& rhs);

  ~SkeletonPointInfo();

  SkeletonPointInfo& operator = (const SkeletonPointInfo& rhs);

 public:
  std::string get_jointType() const {
