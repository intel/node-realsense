...
describe('TrackingInfo API Test', function() {
  describe.skip('SegmentationMask API Existance', function() {
    ...
    it('pt.TrackingInfo() object has the attribute segmentationMask', function() {
      assert.ok(obj.segmentationMask !== undefined);
    });

    it('pt.TrackingInfo() object has the object attribute segmentationMask', function() {
      assert.equal(typeof (obj.segmentationMask), 'object');
    });

    it('pt.TrackingInfo() object has the readonly attribute segmentationMask', function() {
      assert.throws(function() {
        obj.segmentationMask = null;
      });
    });
  });
});
