...
describe('PersonInfo API Test', function() {
  describe('GestureInfo API Existance', function() {
    ...
    it('PersonInfo object has the attribute gestureInfo', function() {
      assert.ok(obj.gestureInfo !== undefined);
    });

    it('PersonInfo object has the object attribute gestureInfo', function() {
      assert.equal(typeof (obj.gestureInfo), 'object');
    });

    it('PersonInfo object has the readonly attribute gestureInfo', function() {
      assert.throws(function() {
        obj.gestureInfo = null;
      });
    });
  });
});
