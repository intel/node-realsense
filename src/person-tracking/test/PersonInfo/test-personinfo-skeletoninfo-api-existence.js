...
describe('PersonInfo API Test', function() {
  describe('SkeletonInfo API Existance', function() {
    ...
    it('PersonInfo object has the attribute skeletonInfo', function() {
      assert.ok(obj.skeletonInfo !== undefined);
    });

    it('PersonInfo object has the object attribute skeletonInfo', function() {
      assert.equal(typeof (obj.skeletonInfo), 'object');
    });

    it('PersonInfo object has the readonly attribute skeletonInfo', function() {
      assert.throws(function() {
        obj.skeletonInfo = null;
      });
    });
  });
});
