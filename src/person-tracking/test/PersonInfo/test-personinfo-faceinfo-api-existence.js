...
describe('PersonInfo API Test', function() {
  describe('faceInfo API Existance', function() {
    ...
    it('PersonInfo object has the attribute faceInfo', function() {
      assert.ok(obj.faceInfo !== undefined);
    });

    it('PersonInfo object has the object attribute faceInfo', function() {
      assert.equal(typeof (obj.faceInfo), 'object');
    });

    it('PersonInfo object has the readonly attribute faceInfo', function() {
      assert.equal(Object.getOwnPropertyDescriptor(obj, 'faceInfo').writable, false);
    });
  });
});
